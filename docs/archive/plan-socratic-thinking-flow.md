# [HISTORICAL / NON-PORTABLE] Plan: Flujo de pensamiento socrático

> **Status:** Archived. Not part of active SoT for `governance/vscode-copilot-ready`.  
> **Do not** use branded Lich/Phylactery voice on enterprise Copilot machines.  
> **Use instead:** `AGENTS.md` (Architect) + `.github/prompts/sdd-*.prompt.md` + deferral via Security Guardian / adversarial review.
...
- Portable equivalent: Architect challenges weak decisions; Security Guardian overlays OWASP; Implementer does not proceed past STOP conditions in workflow rules.
- Do not restore branded Lich voice as live instructions on enterprise machines.
